...
function loadingData() {
    ...
    if (settings.cbxLayout[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[0].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[0].setAttribute("data-active", "false")}
    if (settings.cbxBackground[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[1].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[1].setAttribute("data-active", "false")}
    if (settings.cbxBackgroundMask[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[2].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[2].setAttribute("data-active", "false")}
    if (settings.cbxBorder[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[3].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[3].setAttribute("data-active", "false")}
    if (settings.cbxShadow[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[4].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[4].setAttribute("data-active", "false")}
    if (settings.cbxPosition[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[5].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[5].setAttribute("data-active", "false")}
    if (settings.usnBackground[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[6].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[6].setAttribute("data-active", "false")}
    if (settings.usnBackgroundMask[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[7].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[7].setAttribute("data-active", "false")}
    if (settings.usnBorder[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[8].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[8].setAttribute("data-active", "false")}
    if (settings.usnShadow[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[9].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[9].setAttribute("data-active", "false")}
    if (settings.usnPosition[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[10].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[10].setAttribute("data-active", "false")}
    if (settings.usnFont[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[11].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[11].setAttribute("data-active", "false")}
    if (settings.usnFontShadow[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[12].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[12].setAttribute("data-active", "false")}
    if (settings.usnContent[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[13].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[13].setAttribute("data-active", "false")}
    if (settings.msgBackground[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[14].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[14].setAttribute("data-active", "false")}
    if (settings.msgBackgroundMask[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[15].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[15].setAttribute("data-active", "false")}
    if (settings.msgBorder[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[16].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[16].setAttribute("data-active", "false")}
    if (settings.msgShadow[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[17].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[17].setAttribute("data-active", "false")}
    if (settings.msgPosition[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[18].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[18].setAttribute("data-active", "false")}
    if (settings.msgFont[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[19].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[19].setAttribute("data-active", "false")}
    if (settings.msgFontShadow[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[20].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[20].setAttribute("data-active", "false")}
    if (settings.msgContent[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[21].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[21].setAttribute("data-active", "false")}
    if (settings.othEmotes[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[22].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[22].setAttribute("data-active", "false")}
    if (settings.othBadges[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[23].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[23].setAttribute("data-active", "false")}
    if (settings.anmTiming[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[24].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[24].setAttribute("data-active", "false")}
    if (settings.anmShow[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[25].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[25].setAttribute("data-active", "false")}
    if (settings.anmHide[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[26].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[26].setAttribute("data-active", "false")}
    ...
    document.querySelectorAll(".layoutBtn").forEach(lytBtn => {
        lytBtn.setAttribute("data-active", "false");
    });
    ...
    document.querySelectorAll(".layoutHBtn").forEach(lytBtn => {
        lytBtn.setAttribute("data-active", "false");
    });
            ...
            colorMenu.innerHTML = `
                ...
                <div class="bgSizeSettings">
                    ...
                    <div class="numCont">
                        ...
                        <input class="numContInput" type="number" value="${settings.cbxBackground[`${loadingRole}`].value[i].height.percent}" oninput="updateCbxBGSizePos('height', '%')">
                        <span class="numContUnit">%</span>
                        +
                        <input class="numContInput" type="number" value="${settings.cbxBackground[`${loadingRole}`].value[i].height.px}" oninput="updateCbxBGSizePos('height', 'px')">
                        <span class="numContUnit">px</span>
                    </div>
                </div>
            `;
        ...
        if (settings.cbxBackgroundMask[`${loadingRole}`].value[i].type === "solid") {
            ...
            colorMenu.innerHTML = `
                ...
                <div class="bgSizeSettings">
                    ...
                    <div class="numCont">
                        <span class="numContDescr">height:</span>
                        <input class="numContInput" type="number" value="${settings.cbxBackgroundMask[`${loadingRole}`].value[i].height.percent}" oninput="updateCbxMaskSizePos('height', '%')">
                        <span class="numContUnit">%</span>
                        +
                        <input class="numContInput" type="number" value="${settings.cbxBackgroundMask[`${loadingRole}`].value[i].height.px}" oninput="updateCbxMaskSizePos('height', 'px')">
                        <span class="numContUnit">px</span>
                    </div>
                </div>
            `;
        ...
        if (settings.usnBackground[`${loadingRole}`].value[i].type === "solid") {
            ...
            colorMenu.innerHTML = `
                ...
                <div class="bgSizeSettings">
                    ...
                    <div class="numCont">
                        <span class="numContDescr">height:</span>
                        <input class="numContInput" type="number" value="${settings.usnBackground[`${loadingRole}`].value[i].height.percent}" oninput="updateUsnBGSizePos('height', '%')">
                        <span class="numContUnit">%</span>
                        +
                        <input class="numContInput" type="number" value="${settings.usnBackground[`${loadingRole}`].value[i].height.px}" oninput="updateUsnBGSizePos('height', 'px')">
                        <span class="numContUnit">px</span>
                    </div>
                </div>
            `;
        ...
        if (settings.usnBackgroundMask[`${loadingRole}`].value[i].type === "solid") {
            ...
            colorMenu.innerHTML = `
                ...
                <div class="bgSizeSettings">
                    ...
                    <div class="numCont">
                        <span class="numContDescr">height:</span>
                        <input class="numContInput" type="number" value="${settings.usnBackgroundMask[`${loadingRole}`].value[i].height.percent}" oninput="updateUsnMaskSizePos('height', '%')">
                        <span class="numContUnit">%</span>
                        +
                        <input class="numContInput" type="number" value="${settings.usnBackgroundMask[`${loadingRole}`].value[i].height.px}" oninput="updateUsnMaskSizePos('height', 'px')">
                        <span class="numContUnit">px</span>
                    </div>
                </div>
            `;
    ...
    document.querySelector(".usnSizingRowV").querySelectorAll("button").forEach(sBtn => {
        sBtn.setAttribute("data-active", "false");
    });
        ...
        if (settings.msgBackground[`${loadingRole}`].value[i].type === "solid") {
            ...
            colorMenu.innerHTML = `
                ...
                <div class="bgSizeSettings">
                    ...
                    <div class="numCont">
                        <span class="numContDescr">height:</span>
                        <input class="numContInput" type="number" value="${settings.msgBackground[`${loadingRole}`].value[i].height.percent}" oninput="updateMsgBGSizePos('height', '%')">
                        <span class="numContUnit">%</span>
                        +
                        <input class="numContInput" type="number" value="${settings.msgBackground[`${loadingRole}`].value[i].height.px}" oninput="updateMsgBGSizePos('height', 'px')">
                        <span class="numContUnit">px</span>
                    </div>
                </div>
            `;
        ...
        if (settings.msgBackgroundMask[`${loadingRole}`].value[i].type === "solid") {
            ...
            colorMenu.innerHTML = `
                ...
                <div class="colorChangeCont">
                    ...
                    <div class="colorChangeType selectItemRow">
                        <button onclick="updateColorMsgMaskBox('custom')"><input type="color" class="colorChangeInput" oninput="updateColorMsgMaskBox()"><img class="iconSVG" src="Icons/Diverse/Color.svg"></button>
                        <button onclick="updateColorMsgMaskBox('twitch')" title="Uses the color the user uses in the Twitch chat"><img class="iconSVG" src="Icons/Diverse/TwitchColor.svg"></button>
                    ...
                    <input type="range" class="colorChangeOpacity" value="0" min="0" max="255" step="1" oninput="updateColorMsgMaskBox()" title="Changes the opacity of the selected color">
                    <div class="presetCont">
                        <div class="presetList" data-delete-show="false"></div>
                        <button class="presetAdd" onclick="addPreset()"><img class="iconSVG" src="Icons/Diverse/Add.svg"></button>
                        <button class="presetShowDelete" onclick="showDeletePreset()"><img class="iconSVG" src="Icons/Diverse/Remove.svg"></button>
                ...
                <div class="bgSizeSettings">
                    ...
                    <div class="numCont">
                        <span class="numContDescr">height:</span>
                        <input class="numContInput" type="number" value="${settings.msgBackgroundMask[`${loadingRole}`].value[i].height.percent}" oninput="updateMsgMaskSizePos('height', '%')">
                        <span class="numContUnit">%</span>
                        +
                        <input class="numContInput" type="number" value="${settings.msgBackgroundMask[`${loadingRole}`].value[i].height.px}" oninput="updateMsgMaskSizePos('height', 'px')">
                        <span class="numContUnit">px</span>
                    </div>
                </div>
            `;
    ...
    document.querySelector(".msgSizingRowV").querySelectorAll("button").forEach(sBtn => {
        sBtn.setAttribute("data-active", "false");
    });
    ...
    var languages = [
        ...
        {lang: "Kirghiz", code: "ky"},
        {lang: "Kirundi (Rundi)", code: "rn"},
        {lang: "Korean", code: "ko"},
        {lang: "Kurdish", code: "ku"},
        {lang: "Laothian", code: "lo"},
        {lang: "Latin", code: "la"},
    ...
    languages.forEach(lng => {
        ...
        langBtn.innerHTML = lng.lang;
        langBtn.className = "langButton";
        langBtn.setAttribute("onclick", `updateOthHyphensLang('${lng.code}')`);
    
        document.querySelector(".scrollList").append(langBtn);
    });
    ...
    document.querySelectorAll(".langButton")[Array.from(languages).indexOf(languages.find(item => item.code === settings.othHyphens.lang))].setAttribute("data-active", "true");
