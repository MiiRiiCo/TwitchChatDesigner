                ...
                colorMenu.innerHTML = `
                    <div class="colorSliderAddRow">
                        <div class="colorSliderMoveCont">
                            <button class="colorSliderMoveUp icon" onclick="moveColorSliderCbxBG(event, 'up')"><img class="iconSVG" src="Icons/Diverse/UpLite.svg"></button>
                            <button class="colorSliderMoveDown icon" onclick="moveColorSliderCbxBG(event, 'down')"><img class="iconSVG" src="Icons/Diverse/DownLite.svg"></button>
                        </div>
                    ...
                    <div class="colorChangeCont">
                        ...
                        <input type="range" class="colorChangeOpacity" value="0" min="0" max="255" step="1" oninput="updateColorCbxBG()" data-value="255">
                    ...
                    <button class="showBgSizeBtn" onclick="switchSizeCbxBGBox()"><img class="iconSVG" src="Icons/Diverse/Size.svg"></button>
        ...
        if (type === "solid") {
            ...
            var colorMenu = document.createElement("div");
                ...
                colorMenu.innerHTML = `
                    <div class="colorSliderAddRow">
                        <div class="colorSliderMoveCont">
                            <button class="colorSliderMoveUp icon" onclick="moveColorSliderUsnBG(event, 'up')"><img class="iconSVG" src="Icons/Diverse/UpLite.svg"></button>
                            <button class="colorSliderMoveDown icon" onclick="moveColorSliderUsnBG(event, 'down')"><img class="iconSVG" src="Icons/Diverse/DownLite.svg"></button>
                        </div>
                    ...
                    <div class="colorChangeCont">
                        <button class="hideColorBtn" onclick="hideColorUsnBGBox()"><img class="iconSVG" src="Icons/Diverse/UpLite.svg"></button>
                        <div class="colorChangeType selectItemRow">
                        ...
                        <input type="range" class="colorChangeOpacity" value="0" min="0" max="255" step="1" oninput="updateColorUsnBGBox()" data-value="255">
                        <div class="presetCont">
                            <div class="presetList" data-delete-show="false">${insertPreset()}</div>
                            <button class="presetAdd" onclick="addPreset()"><img class="iconSVG" src="Icons/Diverse/Add.svg"></button>
                            <button class="presetShowDelete" onclick="showDeletePreset()"><img class="iconSVG" src="Icons/Diverse/Remove.svg"></button>
                    ...
                    <button class="showBgSizeBtn" onclick="switchSizeUsnBGBox()"><img class="iconSVG" src="Icons/Diverse/Size.svg"></button>
                    <div class="bgSizeSettings">
                        <div class="numCont">
                            <span class="numContDescr">x-position:</span>
        ...
        if (type === "solid") {
            ...
            var colorMenu = document.createElement("div");
                ...
                colorMenu.innerHTML = `
                    <div class="colorSliderAddRow">
                        <div class="colorSliderMoveCont">
                            <button class="colorSliderMoveUp icon" onclick="moveColorSliderMsgBG(event, 'up')"><img class="iconSVG" src="Icons/Diverse/UpLite.svg"></button>
                            <button class="colorSliderMoveDown icon" onclick="moveColorSliderMsgBG(event, 'down')"><img class="iconSVG" src="Icons/Diverse/DownLite.svg"></button>
                        </div>
                    ...
                    <div class="colorChangeCont">
                        <button class="hideColorBtn" onclick="hideColorMsgBGBox()"><img class="iconSVG" src="Icons/Diverse/UpLite.svg"></button>
                        <div class="colorChangeType selectItemRow">
                        ...
                        <input type="range" class="colorChangeOpacity" value="0" min="0" max="255" step="1" oninput="updateColorMsgBGBox()" data-value="255">
                        <div class="presetCont">
                            <div class="presetList" data-delete-show="false">${insertPreset()}</div>
                            <button class="presetAdd" onclick="addPreset()"><img class="iconSVG" src="Icons/Diverse/Add.svg"></button>
                            <button class="presetShowDelete" onclick="showDeletePreset()"><img class="iconSVG" src="Icons/Diverse/Remove.svg"></button>
                    ...
                    <button class="showBgSizeBtn" onclick="switchSizeMsgBGBox()"><img class="iconSVG" src="Icons/Diverse/Size.svg"></button>
                    <div class="bgSizeSettings">
                        <div class="numCont">
                            <span class="numContDescr">x-position:</span>
