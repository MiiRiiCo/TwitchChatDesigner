...
function updateMaxMsg() {
    settings.genMaxMessages = document.querySelector("#genMaxMsgInput").value;
}
    ...
    if (type === "solid") {
        ...
        var colorMenu = document.createElement("div");
            ...
            colorMenu.innerHTML = `
                ...
                <div class="colorChangeCont">
                    <div class="colorChangeType selectItemRow">
                        <button class="icon" onclick="updateColorUsnBGBox('custom')"><input type="color" class="colorChangeInput" oninput="updateColorUsnBGBox()"> &#xF354;</button>
                        <button class="icon" onclick="updateColorUsnBGBox('twitch')">&#xEA8C;</button>
    ...
    if (type === "solid") {
        ...
        var colorMenu = document.createElement("div");
            ...
            colorMenu.innerHTML = `
                ...
                <div class="colorChangeCont">
                    <div class="colorChangeType selectItemRow">
                        <button class="icon" onclick="updateColorMsgBGBox('custom')"><input type="color" class="colorChangeInput" oninput="updateColorMsgBGBox()"> &#xF354;</button>
                        <button class="icon" onclick="updateColorMsgBGBox('twitch')">&#xEA8C;</button>
