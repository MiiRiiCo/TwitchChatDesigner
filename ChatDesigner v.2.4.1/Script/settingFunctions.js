            ...
            var colorMenu = document.createElement("div");
                ...
                colorMenu.innerHTML = `
                    <div class="colorSliderAddRow">
                        ...
                        <button class="colorSliderDuplicate icon" onclick="duplicateColorSliderCbxBG()"><img class="iconSVG" src="Icons/Diverse/Duplicate.svg"></button>
            ...
            var colorMenu = document.createElement("div");
                ...
                colorMenu.innerHTML = `
                    <div class="colorSliderAddRow">
                        ...
                        <button class="colorSliderDuplicate icon" onclick="duplicateColorSliderUsnBG()"><img class="iconSVG" src="Icons/Diverse/Duplicate.svg"></button>
                        <div class="colorSliderAddCont">
                            <div class="colorSliderDescr">Solid</div>
            ...
            var colorMenu = document.createElement("div");
                ...
                colorMenu.innerHTML = `
                    <div class="colorSliderAddRow">
                        ...
                        <button class="colorSliderDuplicate icon" onclick="duplicateColorSliderMsgBG()"><img class="iconSVG" src="Icons/Diverse/Duplicate.svg"></button>
                        <div class="colorSliderAddCont">
                            <div class="colorSliderDescr">Solid</div>
