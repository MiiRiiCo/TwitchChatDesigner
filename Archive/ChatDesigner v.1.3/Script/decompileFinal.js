...
client.on("message", (streamer, meta, message, self) => {
    console.log(streamer, meta, message, self);
    ...
    fetch(`https://badges.twitch.tv/v1/badges/channels/${meta["room-id"]}/display`)
        ...
        for (var i = 0; i < badgesArray.length; i++) {
            if (channelBadges["badge_sets"][`${badgesArray[i][0]}`]) {
                badgesFinal += `<img class="badgeIcon" src="${channelBadges["badge_sets"][`${badgesArray[i][0]}`]["versions"][`${badgesArray[i][1]}`]["image_url_4x"]}">`;
            } else {
                badgesFinal += `<img class="badgeIcon" src="${allBadges["badge_sets"][`${badgesArray[i][0]}`]["versions"][`${badgesArray[i][1]}`]["image_url_4x"]}">`;
            }
        }
        ...
        if (usernameAllowed === true && messageAllowed === true) {
            ...
            cbx.style.setProperty("--cbxAnmApp", `${settings.anmTiming.appearing}ms`);
            cbx.style.setProperty("--cbxAnmVan", `${settings.anmTiming.vanishing}ms`);
            cbx.style.animation = "showCbx var(--cbxAnmApp)"

            setTimeout(function() {
                document.querySelector("#Cnt").appendChild(cbx);
            }, (settings.anmTiming.delay));

            if (settings.anmTiming.duration !== "infinite") {
                setTimeout(function() {
                    cbx.style.animation = "hideCbx var(--cbxAnmVan)";
                }, (settings.anmTiming.duration + settings.anmTiming.delay + settings.anmTiming.appearing));

                setTimeout(function() {
                    cbx.remove();
                }, (settings.anmTiming.duration + settings.anmTiming.delay + settings.anmTiming.appearing + settings.anmTiming.vanishing));
            }
            
            // settings.anmShow

            if (settings.anmShow[0].active === false) {
                cbx.style.setProperty("--cbxAnmShowScale", "1")
            } else if (settings.anmShow[0].active === true) {
                cbx.style.setProperty("--cbxAnmShowScale", `${settings.anmShow[0].value}`);
            }

            if (settings.anmShow[1].active === false) {
                cbx.style.setProperty("--cbxAnmShowMoveX", "0")
            } else if (settings.anmShow[1].active === true) {
                cbx.style.setProperty("--cbxAnmShowMoveX", `${settings.anmShow[1].value}px`);
            }

            if (settings.anmShow[2].active === false) {
                cbx.style.setProperty("--cbxAnmShowMoveY", "0")
            } else if (settings.anmShow[2].active === true) {
                cbx.style.setProperty("--cbxAnmShowMoveY", `${settings.anmShow[2].value}px`);
            }

            if (settings.anmShow[3].active === false) {
                cbx.style.setProperty("--cbxAnmShowRotateX", "0")
            } else if (settings.anmShow[3].active === true) {
                cbx.style.setProperty("--cbxAnmShowRotateX", `${settings.anmShow[3].value}deg`);
            }

            if (settings.anmShow[4].active === false) {
                cbx.style.setProperty("--cbxAnmShowRotateY", "0")
            } else if (settings.anmShow[4].active === true) {
                cbx.style.setProperty("--cbxAnmShowRotateY", `${settings.anmShow[4].value}deg`);
            }

            if (settings.anmShow[5].active === false) {
                cbx.style.setProperty("--cbxAnmShowRotateZ", "0")
            } else if (settings.anmShow[5].active === true) {
                cbx.style.setProperty("--cbxAnmShowRotateZ", `${settings.anmShow[5].value}deg`);
            }

            if (settings.anmShow[6].active === false) {
                cbx.style.setProperty("--cbxAnmShowOpacity", "100")
            } else if (settings.anmShow[6].active === true) {
                cbx.style.setProperty("--cbxAnmShowOpacity", `${settings.anmShow[6].value}%`);
            }
            
            // settings.anmHide

            if (settings.anmHide[0].active === false) {
                cbx.style.setProperty("--cbxAnmHideScale", "1")
            } else if (settings.anmHide[0].active === true) {
                cbx.style.setProperty("--cbxAnmHideScale", `${settings.anmHide[0].value}`);
            }

            if (settings.anmHide[1].active === false) {
                cbx.style.setProperty("--cbxAnmHideMoveX", "0")
            } else if (settings.anmHide[1].active === true) {
                cbx.style.setProperty("--cbxAnmHideMoveX", `${settings.anmHide[1].value}px`);
            }

            if (settings.anmHide[2].active === false) {
                cbx.style.setProperty("--cbxAnmHideMoveY", "0")
            } else if (settings.anmHide[2].active === true) {
                cbx.style.setProperty("--cbxAnmHideMoveY", `${settings.anmHide[2].value}px`);
            }

            if (settings.anmHide[3].active === false) {
                cbx.style.setProperty("--cbxAnmHideRotateX", "0")
            } else if (settings.anmHide[3].active === true) {
                cbx.style.setProperty("--cbxAnmHideRotateX", `${settings.anmHide[3].value}deg`);
            }

            if (settings.anmHide[4].active === false) {
                cbx.style.setProperty("--cbxAnmHideRotateY", "0")
            } else if (settings.anmHide[4].active === true) {
                cbx.style.setProperty("--cbxAnmHideRotateY", `${settings.anmHide[4].value}deg`);
            }

            if (settings.anmHide[5].active === false) {
                cbx.style.setProperty("--cbxAnmHideRotateZ", "0")
            } else if (settings.anmHide[5].active === true) {
                cbx.style.setProperty("--cbxAnmHideRotateZ", `${settings.anmHide[5].value}deg`);
            }

            if (settings.anmHide[6].active === false) {
                cbx.style.setProperty("--cbxAnmHideOpacity", "100")
            } else if (settings.anmHide[6].active === true) {
                cbx.style.setProperty("--cbxAnmHideOpacity", `${settings.anmHide[6].value}%`);
            }
