...
function updateCbxBGSizePos(cat, value) {
    ...
    if (cat === "posX") {
        if (value === "%") {
            ...
            console.log(settings.cbxBackground[`${activeRole}`]);
            console.log(settings.cbxBackground[`${activeRole}`].value[i]);
            console.log(settings.cbxBackground[`${activeRole}`].value[i].posX);
            console.log(settings.cbxBackground[`${activeRole}`].value[i].posX.percent);
