                ...
                colorMenu.innerHTML = `
                    ...
                    <div class="colorChangeCont">
                        ...
                        <div class="colorChangeType selectItemRow">
                            ...
                            <button class="icon" onclick="updateColorCbxBG('twitch')" title="Uses the color the user uses in the Twitch chat"><img class="iconSVG descrIconSVG" src="Icons/Diverse/TwitchColor.svg"></button>
                        ...
                        <input type="range" class="colorChangeOpacity" value="0" min="0" max="255" step="1" oninput="updateColorCbxBG()" data-value="255" title="Changes the opacity of the selected color">
