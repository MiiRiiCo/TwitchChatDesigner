...
function loadingData() {
    ...
    for (var i = 0; i < settings.cbxBackground[`${loadingRole}`].value.length; i++) {
        ...
        var activeAnchorNum = 0,
            activeAnchor = [false, false, false, false, false, false, false, false, false];

        if (settings.cbxBackground[`${loadingRole}`].value[i].posX === 50) {
            activeAnchorNum += 1
        } else if (settings.cbxBackground[`${loadingRole}`].value[i].posX === 100) {
            activeAnchorNum += 2
        }

        if (settings.cbxBackground[`${loadingRole}`].value[i].posY === 50) {
            activeAnchorNum += 3
        } else if (settings.cbxBackground[`${loadingRole}`].value[i].posY === 100) {
            activeAnchorNum += 6
        }

        activeAnchor[activeAnchorNum] = true;
        ...
        if (settings.cbxBackground[`${loadingRole}`].value[i].type === "solid") {
            ...
            colorMenu.innerHTML = `
                <div class="colorSliderAddRow">
                    ...
                    <button class="colorSliderRmv" onclick="removeGradientCbxBG(event)" title="Removes this background"><img class="iconSVG" src="Icons/Diverse/Remove.svg"></button>
                </div>
                <div class="colorChangeCont">
                    ...
                    <div class="colorChangeType selectItemRow">
                        ...
                        <button onclick="updateColorCbxBG('twitch')" title="Uses the color the user uses in the Twitch chat"><img class="iconSVG" src="Icons/Diverse/TwitchColor.svg"></button>
                    ...
                    <input type="range" class="colorChangeOpacity" value="0" min="0" max="255" step="1" oninput="updateColorCbxBG()" title="Changes the opacity of the selected color">
    ...
    for (var i = 0; i < settings.usnBackground[`${loadingRole}`].value.length; i++) {
        ...
        if (settings.usnBackground[`${loadingRole}`].value[i].posX === 50) {
            activeAnchorNum += 1
        } else if (settings.usnBackground[`${loadingRole}`].value[i].posX === 100) {
            activeAnchorNum += 2
        }
        ...
        if (settings.usnBackground[`${loadingRole}`].value[i].type === "solid") {
            ...
            colorMenu.innerHTML = `
                <div class="colorSliderAddRow">
                    ...
                    <button class="colorSliderRmv" onclick="removeGradientUsnBG(event)" title="Removes this background"><img class="iconSVG" src="Icons/Diverse/Remove.svg"></button>
                </div>
                <div class="colorChangeCont">
                    <button class="hideColorBtn" onclick="hideColorCbxBGBox()" title="Hides the color panel"><img class="iconSVG" src="Icons/Diverse/UpLite.svg"></button>
                    <div class="colorChangeType selectItemRow">
    ...
    for (var i = 0; i < settings.msgBackground[`${loadingRole}`].value.length; i++) {
        ...
        if (settings.msgBackground[`${loadingRole}`].value[i].posX === 50) {
            activeAnchorNum += 1
        } else if (settings.msgBackground[`${loadingRole}`].value[i].posX === 100) {
            activeAnchorNum += 2
        }
        ...
        if (settings.msgBackground[`${loadingRole}`].value[i].type === "solid") {
            ...
            colorMenu.innerHTML = `
                <div class="colorSliderAddRow">
                    ...
                    <button class="colorSliderRmv" onclick="removeGradientMsgBG(event)" title="Removes this background"><img class="iconSVG" src="Icons/Diverse/Remove.svg"></button>
                </div>
                <div class="colorChangeCont">
                    <button class="hideColorBtn" onclick="hideColorCbxBGBox()" title="Hides the color panel"><img class="iconSVG" src="Icons/Diverse/UpLite.svg"></button>
                    <div class="colorChangeType selectItemRow">
                        ...
                        <button onclick="updateColorMsgBG('twitch')" title="Uses the color the user uses in the Twitch chat"><img class="iconSVG" src="Icons/Diverse/TwitchColor.svg"></button>
                    ...
                    <input type="range" class="colorChangeOpacity" value="0" min="0" max="255" step="1" oninput="updateColorMsgBG()" title="Changes the opacity of the selected color">
                    <div class="presetCont">
                        <div class="presetList" data-delete-show="false"></div>
                        <button class="presetAdd" onclick="addPreset()"><img class="iconSVG" src="Icons/Diverse/Add.svg"></button>
                        <button class="presetShowDelete" onclick="showDeletePreset()"><img class="iconSVG" src="Icons/Diverse/Remove.svg"></button>
