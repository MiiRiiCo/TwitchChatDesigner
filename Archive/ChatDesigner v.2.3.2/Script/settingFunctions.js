...
function switchSetCbxBGBox() {
    if (event.target.parentNode.getAttribute("data-set-show") === "false") {
        event.target.parentNode.setAttribute("data-set-show", "true");
    } else {
        event.target.parentNode.setAttribute("data-set-show", "false");
    }
}
