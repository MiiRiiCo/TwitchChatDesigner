...
function loadingData() {
    ...
    if (settings.msgEmotes[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[18].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[18].setAttribute("data-active", "false")}
    if (settings.anmTiming[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[19].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[19].setAttribute("data-active", "false")}
    if (settings.anmShow[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[20].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[20].setAttribute("data-active", "false")}
    if (settings.anmHide[`${loadingRole}`].active === true) {document.querySelectorAll(".roleActiveBtn")[21].setAttribute("data-active", "true")} else {document.querySelectorAll(".roleActiveBtn")[21].setAttribute("data-active", "false")}
    ...
    for (var i = 0; i < settings.cbxBackground[`${loadingRole}`].value.length; i++) {
        ...
        for (var j = 0; j < settings.cbxBackground[`${loadingRole}`].value[i].colors.length; j++) {
            sliderCol += `<input class="colorSlider colorSliderCbxBG" oninput="updateColorSliderCbxBGBox()" onpointerdown="openColorCbxBGBox(${i}, ${j})" type="range" value="${settings.cbxBackground[`${loadingRole}`].value[i].colors[j].position}" min="0" max="100" step="0.1">`
        }
    ...
    for (var i = 0; i < settings.cbxShadow[`${loadingRole}`].value.length; i++) {
        ...
        if (settings.cbxShadow[`${loadingRole}`].value[i].inset === false) {
            shadowElmnt.style.boxShadow = `${settings.cbxShadow[`${loadingRole}`].value[i].xPos}px ${settings.cbxShadow[`${loadingRole}`].value[i].yPos}px ${settings.cbxShadow[`${loadingRole}`].value[i].blur}px ${settings.cbxShadow[`${loadingRole}`].value[i].expand}px ${settings.cbxShadow[`${loadingRole}`].value[i].color.color}${dec2hex(settings.cbxShadow[`${loadingRole}`].value[i].color.opacity)}`;
        } else if (settings.cbxShadow[`${loadingRole}`].value[i].inset === true) {
            shadowElmnt.style.boxShadow = `${settings.cbxShadow[`${loadingRole}`].value[i].xPos}px ${settings.cbxShadow[`${loadingRole}`].value[i].yPos}px ${settings.cbxShadow[`${loadingRole}`].value[i].blur}px ${settings.cbxShadow[`${loadingRole}`].value[i].expand}px ${settings.cbxShadow[`${loadingRole}`].value[i].color.color}${dec2hex(settings.cbxShadow[`${loadingRole}`].value[i].color.opacity)} inset`;
        }
    ...
    for (var i = 0; i < settings.usnShadow[`${loadingRole}`].value.length; i++) {
        ...
        if (settings.usnShadow[`${loadingRole}`].value[i].inset === false) {
            shadowElmnt.style.boxShadow = `${settings.usnShadow[`${loadingRole}`].value[i].xPos}px ${settings.usnShadow[`${loadingRole}`].value[i].yPos}px ${settings.usnShadow[`${loadingRole}`].value[i].blur}px ${settings.usnShadow[`${loadingRole}`].value[i].expand}px ${settings.usnShadow[`${loadingRole}`].value[i].color.color}${dec2hex(settings.usnShadow[`${loadingRole}`].value[i].color.opacity)}`;
        } else if (settings.usnShadow[`${loadingRole}`].value[i].inset === true) {
            shadowElmnt.style.boxShadow = `${settings.usnShadow[`${loadingRole}`].value[i].xPos}px ${settings.usnShadow[`${loadingRole}`].value[i].yPos}px ${settings.usnShadow[`${loadingRole}`].value[i].blur}px ${settings.usnShadow[`${loadingRole}`].value[i].expand}px ${settings.usnShadow[`${loadingRole}`].value[i].color.color}${dec2hex(settings.usnShadow[`${loadingRole}`].value[i].color.opacity)} inset`;
        }
    ...
    for (var i = 0; i < settings.usnFontShadow[`${loadingRole}`].value.length; i++) {
        ...
        fontShadowElmnt.style.boxShadow = `${settings.usnFontShadow[`${loadingRole}`].value[i].xPos}px ${settings.usnFontShadow[`${loadingRole}`].value[i].yPos}px ${settings.usnFontShadow[`${loadingRole}`].value[i].blur}px ${settings.usnFontShadow[`${loadingRole}`].value[i].color.color}${dec2hex(settings.usnFontShadow[`${loadingRole}`].value[i].color.opacity)}`;
    ...
    for (var i = 0; i < settings.msgShadow[`${loadingRole}`].value.length; i++) {
        ...
        if (settings.msgShadow[`${loadingRole}`].value[i].inset === false) {
            shadowElmnt.style.boxShadow = `${settings.msgShadow[`${loadingRole}`].value[i].xPos}px ${settings.msgShadow[`${loadingRole}`].value[i].yPos}px ${settings.msgShadow[`${loadingRole}`].value[i].blur}px ${settings.msgShadow[`${loadingRole}`].value[i].expand}px ${settings.msgShadow[`${loadingRole}`].value[i].color.color}${dec2hex(settings.msgShadow[`${loadingRole}`].value[i].color.opacity)}`;
        } else if (settings.msgShadow[`${loadingRole}`].value[i].inset === true) {
            shadowElmnt.style.boxShadow = `${settings.msgShadow[`${loadingRole}`].value[i].xPos}px ${settings.msgShadow[`${loadingRole}`].value[i].yPos}px ${settings.msgShadow[`${loadingRole}`].value[i].blur}px ${settings.msgShadow[`${loadingRole}`].value[i].expand}px ${settings.msgShadow[`${loadingRole}`].value[i].color.color}${dec2hex(settings.msgShadow[`${loadingRole}`].value[i].color.opacity)} inset`;
        }
    ...
    for (var i = 0; i < settings.msgFontShadow[`${loadingRole}`].value.length; i++) {
        ...
        fontShadowElmnt.style.boxShadow = `${settings.msgFontShadow[`${loadingRole}`].value[i].xPos}px ${settings.msgFontShadow[`${loadingRole}`].value[i].yPos}px ${settings.msgFontShadow[`${loadingRole}`].value[i].blur}px ${settings.msgFontShadow[`${loadingRole}`].value[i].color.color}${dec2hex(settings.msgFontShadow[`${loadingRole}`].value[i].color.opacity)}`;
    ...
    document.querySelector("#msgEmoteSizeInp").value = settings.msgEmotes[`${loadingRole}`].value.height;
    document.querySelector(".emoteSizeAutoBtn").setAttribute("data-active", settings.msgEmotes[`${loadingRole}`].value.auto);
    ...
    if (settings.msgEmotes[`${loadingRole}`].value.linePos === "top") {
        document.querySelectorAll(".emoteAlignBtn")[0].setAttribute("data-active", "true");
    } else if (settings.msgEmotes[`${loadingRole}`].value.linePos === "middle") {
        document.querySelectorAll(".emoteAlignBtn")[1].setAttribute("data-active", "true");
    } else if (settings.msgEmotes[`${loadingRole}`].value.linePos === "bottom") {
    ...
    for (var i = 0; i < settings.anmShow[`${loadingRole}`].value.length; i++) {
    ...
    for (var i = 0; i < settings.anmHide[`${loadingRole}`].value.length; i++) {
